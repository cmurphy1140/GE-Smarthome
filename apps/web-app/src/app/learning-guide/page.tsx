            ...
            {marketPosition.map(position => {
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 inline-flex rounded-xl border border-blue-950/15 bg-blue-950/5 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.35em] text-blue-950">
                    {position.callout}
                  </div>
                </motion.article>
              )
